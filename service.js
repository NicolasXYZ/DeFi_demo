...
console.log('bignum converted')
const tokenAmountHex = '0x' + tokenAmount.mul(web3.utils.toBN(10).pow(decimals)).toString('hex');
   await underlying.methods.transfer( AccountList[user] , tokenAmountHex).send({
    from: AccountList[9-user],
    gasLimit: web3.utils.toHex(6721975),
    //mantissa: false,
    gasPrice: web3.utils.toHex(300)
...
console.log('bignum converted')
const tokenAmountHex = '0x' + tokenAmount.mul(web3.utils.toBN(10).pow(decimals)).toString('hex');
   await underlying.methods.transfer( AccountList[9-user] , tokenAmountHex).send({
    from: AccountList[user],
    gasLimit: web3.utils.toHex(6721975),
    //mantissa: false,
    gasPrice: web3.utils.toHex(300)
  ...
  var response = {
    "text": " new balance of: " + cTokenBalance 
  };
  res = 'good'
  console.log(res)
  console.log(response)
